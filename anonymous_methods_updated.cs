...
namespace Anonymous_methods
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Compute the results of each opertation => mult, div, add
            Console.WriteLine("The result of mult: {0}", mult(n3, n4));
            Console.WriteLine("The result of div: {0}", div(n3, n4));
            Console.WriteLine("The result of add: {0}", add(n3, n4));
